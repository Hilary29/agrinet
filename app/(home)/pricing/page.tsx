...
const variantStyles = {
  ...
  pro: {
    container:
      "border-none bg-gradient-to-br from-primary-100 to-accent-100 dark:bg-purple-950",
  ...
  >
    <CardHeader className="pb-8 pt-4">
      <div className="flex justify-between items-center">
        <CardTitle className={cn("text-lg", variantStyles[variant].title)}>
          {title}
        </CardTitle>
      ...
      <CardDescription
        className={cn("pt-1.5 h-12", variantStyles[variant].description)}
      >
        {description}
      </CardDescription>
    </CardHeader>
    ...
    <div className="flex flex-col items-start w-full px-4 sm:px-6 md:px-8 lg:px-32 pt-28 md:pt-32">
      ...
      <div className="flex flex-col items-center w-full max-w-[1186px] mx-auto gap-8 sm:gap-12 lg:gap-14">
        <div className="text-center max-w-2xl">
          <h1 className="text-3xl lg:text-4xl font-semibold font-satoshi text-heading-desktop-h2 text-black-100 mb-6">
            Pricing Plans
          </h1>
        ...
        <PricingSwitch
          onSwitch={(value) => setIsYearly(parseInt(value) === 1)}
        />
