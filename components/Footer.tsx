...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white pt-28 py-8 px-6 sm:px-16 w-full">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row justify-between mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 md:gap-16 xl:gap-32">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/how-it-works" className="text-[#4B4B4B]">
                    How it Works
                  </Link>
                </li>
                <li>
                  <Link href="/marketplace" className="text-[#4B4B4B]">
                    Marketplace
                  </Link>
                </li>
              </ul>
            ...
            <div>
              <h3 className="text-[#072B1C] font-medium mb-4">Resources</h3>
              <ul className="space-y-2">
                <li>
                ...
                <li>
                  <Link href="/podcasts" className="text-[#4B4B4B]">
                    Podcasts
                  </Link>
                </li>
                <li>
                  <Link href="/educational-hub" className="text-[#4B4B4B]">
                    Educational Hub
                  </Link>
                </li>
                <li>
                  <Link href="/case-studies" className="text-[#4B4B4B]">
                    Case Studies
                  </Link>
                </li>
              </ul>
