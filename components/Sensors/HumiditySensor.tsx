// components/HumiditySensor.tsx
import React, { useState } from "react";
import { LineChart, Line, XAxis, YAxis, Tooltip, CartesianGrid, ResponsiveContainer } from "recharts";
import { HumidityData } from "@/public/data/iotdatagenrator";

const HumiditySensor: React.FC = () => {
  ...
  // Filter data for the selected year and trimonth
  ...
  const filteredData = filterData(HumidityData);
